...
export function TronFloatingPanel({
  ...
  return (
    ...
    >
      {/* Corner decorations */}
      <TronHUDCornerFrame position={position === "left" ? "top-left" : "top-right"} size={16} />
      <TronHUDCornerFrame position={position === "left" ? "bottom-left" : "bottom-right"} size={16} />
...
interface TronLocationDisplayProps extends React.HTMLAttributes<HTMLDivElement> {
  sector?: string
  grid?: string
  coordinates?: string
  status?: string
