          ...
          return (
            ...
            >
              ...
              >
                ...
                <div
                  className={cn(
                    "relative z-10 flex h-8 w-8 shrink-0 items-center justify-center rounded-full border-2 font-bold font-mono text-xs transition-all duration-500",
                    isCompleted &&
                    ...
                    {isActive && (
                      <div
                        ...
                        style={{
                          ...
                          ...(isVertical
                            ? { height: "40%", left: 0, right: 0, top: 0 }
                            : { bottom: 0, left: 0, top: 0, width: "40%" }),
                        }}
                      />
                    )}
                  </div>
              ...
              >
                ...
                {step.description ? (
                  <div className="mt-0.5 text-[9px] text-foreground/50 leading-relaxed">
                    {step.description}
                  </div>
                ) : null}
              </div>
