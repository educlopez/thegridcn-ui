...
export function Toggle({
  ...
  const sizes = {
    lg: { thumb: "h-4.5 w-4.5", track: "h-6 w-12", translate: "translate-x-6" },
    md: { thumb: "h-3.5 w-3.5", track: "h-5 w-10", translate: "translate-x-5" },
    sm: { thumb: "h-3 w-3", track: "h-4 w-8", translate: "translate-x-4" },
  };
        ...
        <span
          className={cn(
            ...
            isChecked
              ? cn(
                  s.translate,
                  "ml-0.5 border-primary bg-primary shadow-[0_0_6px_rgba(var(--primary-rgb,0,180,255),0.5)]"
                )
