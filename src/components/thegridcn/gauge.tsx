...
const sizeConfig = {
  lg: { dim: 200, fontSize: 30, labelSize: "text-xs", needle: 65, stroke: 10 },
  md: {
    dim: 150,
    fontSize: 22,
    labelSize: "text-[10px]",
...
export function Gauge({
  ...
  const ticks = Array.from({ length: tickCount }, (_, i) => {
    ...
    return { inner, major: i % 2 === 0, outer, rad };
  });
    ...
    >
      ...
      >
        ...
        <text
          ...
          className={cn("font-bold font-mono", variantText[resolvedVariant])}
          fill="currentColor"
