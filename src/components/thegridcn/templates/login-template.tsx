...
export function LoginTemplate() {
  ...
  return (
    <div className="flex min-h-screen bg-background text-foreground">
      ...
      <div className="relative hidden w-1/2 overflow-hidden border-primary/20 border-r lg:flex lg:flex-col lg:items-center lg:justify-center">
        <CircuitBackground
          animated
          opacity={0.08}
        ...
        <div className="relative z-10 flex max-w-md flex-col items-center px-12 text-center">
          ...
          {/* Brand */}
          <h1 className="font-[family-name:var(--font-orbitron)] font-bold text-3xl text-foreground uppercase tracking-[0.2em]">
            The Gridcn
          </h1>
          ...
          {/* Description */}
          <p className="mt-6 text-foreground/50 text-sm leading-relaxed">
          ...
          <div className="mt-10 space-y-4 text-left">
            {[
              ...
              <div key={item.label} className="flex items-center gap-3">
                ...
                <span className="font-mono text-foreground/60 text-xs tracking-wide">
                  {item.label}
                </span>
              </div>
            ))}
          ...
          <div className="mt-12 w-full rounded border border-primary/20 bg-primary/5 px-4 py-3">
            <div className="flex items-center justify-between">
              <span className="font-mono text-[9px] text-primary/50 uppercase tracking-widest">
                System Status
              </span>
              <span className="flex items-center gap-1.5">
                <span className="h-1.5 w-1.5 rounded-full bg-green-500 shadow-[0_0_6px_rgba(34,197,94,0.6)]" />
                <span className="font-mono text-[9px] text-green-500/80 uppercase tracking-widest">
        ...
        {/* Corner decorations */}
        <div className="pointer-events-none absolute top-4 left-4 h-8 w-8 border-primary/20 border-t-2 border-l-2" />
        <div className="pointer-events-none absolute top-4 right-4 h-8 w-8 border-primary/20 border-t-2 border-r-2" />
        <div className="pointer-events-none absolute bottom-4 left-4 h-8 w-8 border-primary/20 border-b-2 border-l-2" />
        <div className="pointer-events-none absolute right-4 bottom-4 h-8 w-8 border-primary/20 border-r-2 border-b-2" />
      </div>
      ...
      <div className="relative flex w-full items-center justify-center px-6 py-12 lg:w-1/2">
        ...
        <div className="relative z-10 w-full max-w-sm">
          ...
          <div className="mb-8 flex flex-col items-center lg:hidden">
            ...
            <span className="font-[family-name:var(--font-orbitron)] font-bold text-foreground text-lg uppercase tracking-[0.15em]">
              The Gridcn
            </span>
          </div>
          ...
          >
            ...
            {/* Corner decorations */}
            <div className="pointer-events-none absolute top-0 left-0 h-4 w-4 border-primary/30 border-t-2 border-l-2" />
            <div className="pointer-events-none absolute top-0 right-0 h-4 w-4 border-primary/30 border-t-2 border-r-2" />
            <div className="pointer-events-none absolute bottom-0 left-0 h-4 w-4 border-primary/30 border-b-2 border-l-2" />
            <div className="pointer-events-none absolute right-0 bottom-0 h-4 w-4 border-primary/30 border-r-2 border-b-2" />
            ...
            <div className="relative mb-6 text-center">
              ...
              <h2 className="mt-3 font-[family-name:var(--font-orbitron)] font-bold text-foreground text-xl uppercase tracking-wider lg:mt-4">
                Sign In
              </h2>
              <p className="mt-1 font-mono text-[10px] text-foreground/40 uppercase tracking-widest">
            ...
            >
              ...
              <div className="space-y-2">
                <Label
                  htmlFor="email"
                  className="font-mono text-[10px] text-foreground/60 uppercase tracking-widest"
                >
                  Email Address
                </Label>
                <Input
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute top-1/2 right-3 -translate-y-1/2 text-foreground/30 transition-colors hover:text-primary"
                    aria-label={
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <Label
                    htmlFor="remember"
                    className="cursor-pointer font-mono text-[10px] text-foreground/50 uppercase tracking-widest"
                  >
                    Remember me
                  </Label>
                </div>
                <a
                  href="#"
                  className="font-mono text-[10px] text-primary/60 uppercase tracking-widest transition-colors hover:text-primary"
                >
                  Forgot password?
                </a>
              </div>
            ...
            <div className="relative my-6 flex items-center">
              <div className="flex-1 border-primary/15 border-t" />
              <span className="px-3 font-mono text-[9px] text-foreground/30 uppercase tracking-widest">
                or continue with
              </span>
              <div className="flex-1 border-primary/15 border-t" />
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="font-mono text-[8px] text-foreground/20 uppercase tracking-[0.2em]">
