...
const BLOG_BREADCRUMBS = [
  { href: "#", label: "Home" },
  { href: "#", label: "Blog" },
  { active: true, label: "Building Interfaces in the Grid" },
];
...
const TABLE_OF_CONTENTS = [
  ...
  { href: "#grid-architecture", label: "Grid Architecture" },
  { href: "#building-components", label: "Building Components" },
  { href: "#data-flow", label: "Data Flow Patterns" },
  { href: "#visual-design", label: "Visual Design Principles" },
...
export function BlogTemplate() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      {/* ── Top Bar ─────────────────────────────────── */}
      <div className="border-primary/20 border-b bg-background/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-2">
          ...
          <div className="flex items-center gap-4">
            <span className="hidden font-mono text-[10px] text-foreground/40 uppercase tracking-widest sm:block">
          ...
          <article className="min-w-0 flex-1">
            ...
            <header className="mb-8">
              ...
              <div className="mb-4 flex flex-wrap gap-2">
                {ARTICLE_TAGS.map((tag) => (
                  <span
                    key={tag}
                    className="inline-flex items-center gap-1 rounded border border-primary/20 bg-primary/5 px-2.5 py-0.5 font-mono text-[10px] text-primary/70 uppercase tracking-wider transition-colors hover:border-primary/40 hover:text-primary"
                  >
              ...
              {/* Title */}
              <h1 className="font-[family-name:var(--font-orbitron)] font-bold text-2xl text-foreground uppercase tracking-wider md:text-3xl lg:text-4xl">
                {ARTICLE.title}
              </h1>

              {/* Subtitle */}
              <p className="mt-3 text-foreground/60 text-sm leading-relaxed md:text-base">
                {ARTICLE.subtitle}
              </p>

              {/* Author + Meta */}
              <div className="mt-6 flex flex-wrap items-center gap-4 border-primary/10 border-t pt-6">
                <div className="flex items-center gap-3">
                  <AgentAvatar
                    seed={AUTHOR.name}
                    size={40}
            ...
            <div className="prose-gridcn space-y-8">
              ...
              <section id="introduction">
                <h2 className="font-[family-name:var(--font-orbitron)] font-bold text-foreground text-lg uppercase tracking-wider md:text-xl">
                  Introduction
                </h2>
              ...
              <section id="grid-architecture">
                ...
                <h3 className="mt-6 font-[family-name:var(--font-orbitron)] font-semibold text-foreground/90 text-sm uppercase tracking-wider">
                  Core Principles
                </h3>
              ...
              <section id="data-flow">
                  ...
                  >
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-2 font-mono text-[10px] text-primary/50 uppercase tracking-widest">
                ...
                <ol className="mt-3 space-y-2 pl-4">
                  {[
                    ...
                    >
                      <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded border border-primary/30 bg-primary/10 font-bold font-mono text-[10px] text-primary">
                        {i + 1}
                      </span>
                      <span>{step}</span>
                    </li>
            ...
            <footer className="mt-12 space-y-8">
              {/* Share buttons */}
              <div className="flex items-center justify-between border-primary/10 border-t pt-6">
              ...
              <div className="relative overflow-hidden rounded border border-primary/20 bg-card/80 p-5 backdrop-blur-sm">
                ...
                <div className="relative flex flex-col gap-4 sm:flex-row">
                  ...
                  <div className="flex-1">
                    <div className="font-mono text-[10px] text-primary/50 uppercase tracking-widest">
                      About the Author
                    </div>
                    <div className="mt-1 font-bold text-foreground text-sm uppercase tracking-wider">
                      {AUTHOR.name}
                    </div>
                    <div className="text-[10px] text-foreground/40 uppercase tracking-widest">
                      {AUTHOR.role}
              ...
              <div>
                <div className="mb-6 flex items-center gap-3">
                  ...
                  <span className="font-[family-name:var(--font-orbitron)] font-semibold text-foreground/50 text-xs uppercase tracking-wider">
                  ...
                  {RELATED_ARTICLES.map((article) => (
                    ...
                    >
                      ...
                      <div className="relative">
                        ...
                        <h3 className="mt-2 font-[family-name:var(--font-orbitron)] font-bold text-foreground text-xs uppercase tracking-wider transition-colors group-hover:text-primary">
                          {article.title}
                        </h3>
                        <p className="mt-1.5 text-foreground/50 text-xs leading-relaxed">
                          {article.excerpt}
                        </p>
                        <div className="mt-3 flex items-center gap-1.5 font-mono text-[10px] text-primary/60 uppercase tracking-widest transition-colors group-hover:text-primary">
                          Read more
                          <ArrowRight className="h-3 w-3 transition-transform group-hover:translate-x-0.5" />
                        </div>
                      </div>
                      {/* Corner decorations */}
                      <div className="pointer-events-none absolute top-0 left-0 h-2.5 w-2.5 border-primary/20 border-t-2 border-l-2 transition-colors group-hover:border-primary/40" />
                      <div className="pointer-events-none absolute right-0 bottom-0 h-2.5 w-2.5 border-primary/20 border-r-2 border-b-2 transition-colors group-hover:border-primary/40" />
                    </a>
                  ))}
                </div>
              </div>
          ...
          <aside className="w-full shrink-0 space-y-6 lg:sticky lg:top-20 lg:w-72 lg:self-start">
            ...
            <div className="relative overflow-hidden rounded border border-primary/20 bg-card/80 p-4 backdrop-blur-sm">
              ...
              <div className="relative flex flex-col items-center text-center">
                ...
                <div className="mt-3 font-bold text-foreground text-xs uppercase tracking-wider">
                  {AUTHOR.name}
                </div>
                <div className="text-[10px] text-foreground/40 uppercase tracking-widest">
                  {AUTHOR.role}
                ...
                <button
                  type="button"
                  className="mt-3 w-full rounded border border-primary/30 bg-primary/10 px-3 py-1.5 font-mono text-[10px] text-primary uppercase tracking-widest transition-colors hover:bg-primary/20"
                >
                  View all posts
                </button>
              </div>
            ...
            <div className="relative overflow-hidden rounded border border-primary/20 bg-card/80 p-4 backdrop-blur-sm">
              <div className="pointer-events-none absolute inset-0 bg-[repeating-linear-gradient(0deg,transparent,transparent_2px,rgba(0,0,0,0.03)_2px,rgba(0,0,0,0.03)_4px)]" />
              <div className="relative">
                <div className="mb-3 font-mono text-[10px] text-foreground/50 uppercase tracking-widest">
                  Related Transmissions
                </div>
                <div className="space-y-3">
                  {RELATED_ARTICLES.map((article) => (
                    <a
                      key={article.title}
                      href={article.slug}
                      className="group block border-primary/10 border-b pb-3 last:border-0 last:pb-0"
                    >
                      <div className="font-mono text-[10px] text-foreground/30">
                        {article.date}
                      </div>
                      <div className="mt-0.5 font-semibold text-foreground/70 text-xs uppercase tracking-wider transition-colors group-hover:text-primary">
                        {article.title}
                      </div>
                    </a>
                  ))}
      ...
      {showScrollTop ? (
        <button
          ...
          className="fixed right-6 bottom-6 z-40 flex h-10 w-10 items-center justify-center rounded border border-primary/30 bg-background/90 text-primary/60 shadow-lg backdrop-blur-sm transition-all hover:border-primary/50 hover:text-primary"
