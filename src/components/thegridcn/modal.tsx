      ...
      >
        ...
        {title || description ? (
          <div className="border-primary/20 border-b px-5 py-3">
            {title ? (
              <h3 className="font-mono text-primary text-xs uppercase tracking-widest">
                {title}
              </h3>
            ) : null}
            {description ? (
        ...
        {/* Footer */}
        {footer ? (
          <div className="flex items-center justify-end gap-2 border-primary/20 border-t px-5 py-3">
            {footer}
          </div>
        ) : null}
