  ...
  return (
    <div
      ...
      className={cn(
        ...
        variant === "default" &&
          "border-primary/30 border-b bg-primary/5 text-foreground/80",
        variant === "highlight" &&
          "border-primary/50 border-b bg-primary/10 text-primary",
        variant === "warning" &&
          "border-amber-500/30 border-b bg-amber-500/5 text-amber-400/90",
        className
      )}
      {...props}
    >
