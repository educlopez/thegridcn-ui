...
this skill for developing `educlopez/thegridcn-ui`.
...
```bash
gh issue list --repo educlopez/thegridcn-ui --label friction --state open
```
...
```bash
gh issue create --repo educlopez/thegridcn-ui --title "Friction: …" --label friction --body-file -
```
